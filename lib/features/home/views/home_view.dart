    ...
    return MultiBlocProvider(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          // ✅ Search
                          CustomSearchField(onTap: () => context.push(AppRouterKeys.search), readOnly: true, ),
                          SizedBox(height: 16.h),
                      ...
                      delegate: SliverChildBuilderDelegate(
                        (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              context.push(AppRouterKeys.productDetails,
                              extra: product);
                            },
                            child: Container(
                              decoration: BoxDecoration(
         ...
         // في HomeView أو MainLayout
floatingActionButton: BlocBuilder<CartCubit, CartState>(
  builder: (context, state) {
    final cartCubit = context.read<CartCubit>();
    final itemCount = cartCubit.itemCount;
